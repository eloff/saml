...
// RSA implements Encrypter and Decrypter using public key
// encrytion. Use function like OAEP(), or PKCS1v15() to get an instance
// of this type ready to use.
type RSA struct {
...
func (e RSA) Encrypt(certificate interface{}, plaintext []byte) (*etree.Element, error) {
	...
	if !ok {
		return nil, ErrIncorrectKeyType("ASN.1 []byte containing an RSA public key")
	}
